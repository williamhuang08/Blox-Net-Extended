...
## OpenAI API Key
Blox-Net uses the ChatGPT [OpenAI API](https://platform.openai.com/docs/quickstart#create-and-export-an-api-key), create a file named ```.env``` in the home directory of the repository and include ```OPENAI_API_KEY=[your api key]```
