...
def run_monte_carlo (block:Block, assembly, num_circles=10, min_radius = 0.5, max_radius = 5, original_position_status=False, debug = False, pos_threshold=0.1, rot_threshold=0.1, num_points_per_circle = 8):
    ...
    for radius in circle_radii:
        monte_carlo_positions [radius] = circle_sample(radius, num_points_per_circle, original_coordinates)
