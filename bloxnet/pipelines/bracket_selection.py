    ...
    def recursive_compare(remaining_images, compare_function):
        ...
        for i in range(0, len(remaining_images), 2):
            ...
            if img2 is None:
                ...
                winner = (image_ls[idx1], idx1) if winner == 0 else (image_ls[idx2], idx2)
...
def get_best_assembly(assemblies: List[Assembly], use_rating = True, use_stability = False):
    ...
    if use_stability:
        filtered_assemblies = [assembly for assembly in assemblies if stability_check(assembly.structure.structure)[0]]
    ...
    to_build, structure_directory = top_assemblies[0].to_build, top_assemblies[0].structure_directory
