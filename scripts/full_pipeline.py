...
from bloxnet.utils.utils import slugify, write_error
from scripts.run_pipeline_single_obj_parallel import (
    main_run_pipeline_single_obj_parallel,
)
...
if __name__ == "__main__":
    ...
    print(start)
    process_map(
        error_catch_main_run_pipeline_single_obj_parallel,
        structure_names,
        max_workers=16,
    )
